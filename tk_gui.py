...
def edit_user():
    ...
    button_dodaj_uztykownika.config(text='zapisz', command=lambda: update_user(i))
...
def update_user(i):
    ...
    display_users()
    button_dodaj_uztykownika.config(text='dodaj uzytkownika', command=add_new_user)
...
button_edytuj_uzytkownika = Button(ramka_lista_uzytkownikow, text='Edytuj', comman=edit_user)
